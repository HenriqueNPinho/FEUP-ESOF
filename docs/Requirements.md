...
### As a Authenticated Student, I want to take a online ticket so that I don´t need to go physically to the place. 

<br>

> ### **Feature: Take a online ticket**
  ...
  ### Scenario: The authenticated student takes succefully a ticket
  ...
  * Then he can denie the ticket confimation
...
> ### **Feature: Cancel the ticket**
 ...
 #### **Rule: The authenticated student can only cancel 3 ticekts per 24 hours**
  ...
  * But he will no longer can take another ticket in 12 hours
  ...
  * Then he gets a 12 hours ban

</li>

<li>

###  As a Authenticated Student, I want to get served as soon as my ticket number shows on the screen.

> ### **Feature: Getting served**
  #### **Rule: The student can´t have his ticket canceled**

  ### Scenario: The student goes to the Academic Services and gets his served
  * Given an student with his ticket
  ...
  * Then he gets a 12 hours ban in the application
...
> ### **Feature: Login into the application**
  ### Scenario: The student login into the application
  * Given an student registered in the application
  
  * And he writes his credentials right in the form

  * Then he can succefully login
...
> ### **Feature: Log out of the application**
  ...
  * Given an student logged into the application
...
> ### **Feature: Recive Notifications**
  ### Scenario: The authenticated student already took the ticket 

  * Given an authenticated student waiting to be served Academic Services

  * Then he recives an notification in his phone

  * And he can get going to Academic Services
...
> ### **Feature: Feedback of the service**
  ...
  * Then he can watch the service rate in the Academic Services
